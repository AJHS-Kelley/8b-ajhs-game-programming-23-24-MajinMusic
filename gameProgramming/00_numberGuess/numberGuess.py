...
while playerScore == -1 and cpuScore == -1:
    ...
    difficulty = str(input("Type what difficulty you'd like and push ENTER. \n Anything other than the difficulties presented will set the difficulty to medium\n"))
    ...
    while playerScore != 3 and cpuScore != 3:
        ...
        if playerScore >= 1 or cpuScore >= 1:
            print("You completed a round! Choose a difficulty for the next one!")
            print("Difficulties: easy, medium, hard\n")
            difficulty = str(input("Type what difficulty you'd like and push ENTER. \n Anything other than the difficulties presented will set the difficulty to medium\n"))
